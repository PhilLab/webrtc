...
VideoCaptureIPhoneAVFoundation::VideoCaptureIPhoneAVFoundation(const int32_t id) :
    VideoCaptureImpl(id),
  _isCapturing(false),
    _id(id),
...
int32_t VideoCaptureIPhoneAVFoundation::Init(
...
int32_t VideoCaptureIPhoneAVFoundation::StartCapture(
...
int32_t VideoCaptureIPhoneAVFoundation::StopCapture()
{
    CriticalSectionScoped cs(&_apiCs);
...
int32_t VideoCaptureIPhoneAVFoundation::CaptureSettings(VideoCaptureCapability& settings)
{
    CriticalSectionScoped cs(&_apiCs);
