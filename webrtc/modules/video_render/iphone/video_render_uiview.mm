...
int32_t VideoChannelUIView::GetChannelProperties(float& left,
        float& top,
        float& right,
        float& bottom)
{
 ...
 */
int32_t VideoRenderUIView::StartRender()
{
...
int32_t VideoRenderUIView::StopRender()
{
...
int32_t VideoRenderUIView::DeleteNSGLChannel(const uint32_t channel)
{
...
int32_t VideoRenderUIView::GetChannelProperties(const uint16_t streamId,
        uint32_t& zOrder,
        float& left,
        float& top,
        float& right,
...
int32_t VideoRenderUIView::ChangeUniqueID(int32_t id)
{
...
int32_t VideoRenderUIView::SetText(const uint8_t /*textId*/,
        const uint8_t* /*text*/,
