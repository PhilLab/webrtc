...
TEST(AudioCodingModuleUnitTest, DISABLED_ON_ANDROID(TestEncodeDecode)) {
  Trace::CreateTrace();
  Trace::SetTraceFile((webrtc::test::OutputPath() +
...
TEST(AudioCodingModuleUnitTest, DISABLED_ON_ANDROID(TestRedFec)) {
  Trace::CreateTrace();
  Trace::SetTraceFile((webrtc::test::OutputPath() +
...
TEST(AudioCodingModuleUnitTest, DISABLED_ON_ANDROID(TestIsac)) {
  Trace::CreateTrace();
  Trace::SetTraceFile((webrtc::test::OutputPath() +
...
TEST(AudioCodingModuleUnitTest, DISABLED_ON_ANDROID(TwoWayCommunication)) {
  Trace::CreateTrace();
  Trace::SetTraceFile((webrtc::test::OutputPath() +
...
TEST(AudioCodingModuleUnitTest, DISABLED_ON_ANDROID(TestStereo)) {
  Trace::CreateTrace();
  Trace::SetTraceFile((webrtc::test::OutputPath() +
...
TEST(AudioCodingModuleUnitTest, DISABLED_ON_ANDROID(TestWebRtcVadDtx)) {
  Trace::CreateTrace();
  Trace::SetTraceFile((webrtc::test::OutputPath() +
