...
public:
    ...
    virtual int32_t IncomingAVIVideoData(const int8_t* audioBuffer,
                                         const size_t bufferLength) OVERRIDE;
    virtual int32_t IncomingMP4AudioData(const int8_t*  buffer,
                                         const size_t bufferLengthInBytes,
                                         const uint32_t timeStamp) OVERRIDE;
    virtual int32_t IncomingMP4VideoData(const int8_t*  audioBuffer,
    ...
    virtual int32_t StartRecordingVideoFile(
        ...
        bool                saveVideoToLibrary = false) OVERRIDE;
