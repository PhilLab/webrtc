...
int ViECaptureImpl::SetDefaultCapturedFrameOrientation(
  ...
  const char* s_orientation;
  switch (orientation) {
    case CapturedFrameOrientation_LandscapeLeft:
      s_orientation = "Landscape Left";
      break;
  ...
  LOG(LS_INFO) << "SetDefaultCapturedFrameOrientation for " << capture_id
    ...
    const CapturedFrameOrientation orientation)
{
  ...
  LOG(LS_INFO) << "SetCapturedFrameLockedOrientation for " << capture_id
               << ", orientation " << s_orientation;
...
int ViECaptureImpl::EnableCapturedFrameOrientationLock(
    ...
    const bool enable)
{
  LOG(LS_INFO) << "EnableCapturedFrameOrientationLock for " << capture_id
