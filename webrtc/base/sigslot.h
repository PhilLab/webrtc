...
//
// Copyright 2002 by Sarah Thompson (sarah@telergy.com)
//
...
//
//    #define switches
//      SIGSLOT_PURE_ISO      - Define this to force ISO C++ compliance.
//                       This also disables all of the thread safety support
//                       on platforms where it is available.
//
//      SIGSLOT_USE_POSIX_THREADS  - Force use of Posix threads when using a
//                       C++ compiler other than gcc on a platform that
//                       supports Posix threads. (When using gcc, this is
//                       the default - use SIGSLOT_PURE_ISO to disable this if
//                       necessary)
//
//      SIGSLOT_DEFAULT_MT_POLICY  - Where thread support is enabled, this
//                      defaults to multi_threaded_global. Otherwise, the
//                       default is single_threaded. #define this yourself to
//                      override the default. In pure ISO mode, anything other
//                       than single_threaded will cause a compiler error.
//
//    PLATFORM NOTES
//
//      Win32            - On Win32, the WEBRTC_WIN symbol must be #defined.
//                       Most mainstream compilers do this by default, but
//                       you may need to define it yourself if your build
//                       environment is less standard. This causes the Win32
//                       thread support to be compiled in and used
//                       automatically.
//
//      Unix/Linux/BSD, etc.    - If you're using gcc, it is assumed that you
//                      have Posix threads available, so they are used
//                      automatically. You can override this (as under Windows)
//                      with the SIGSLOT_PURE_ISO switch. If you're using
//                      something other than gcc but still want to use Posix
//                      threads, you need to #define SIGSLOT_USE_POSIX_THREADS.
//
//      ISO C++         - If none of the supported platforms are detected, or
//                      if SIGSLOT_PURE_ISO is defined, all multithreading
//                      support is turned off, along with any code that might
//                      cause a pure ISO C++ environment to complain. Before
//                      you ask, gcc -ansi -pedantic won't compile this
//                      library, but gcc -ansi is fine. Pedantic mode seems to
//                      throw a lot of errors that aren't really there. If you
//                      feel like investigating this,please contact the author.
//
//
//    THREADING MODES
//
//      single_threaded   - Your program is assumed to be single threaded from
//                      the point of view of signal/slot usage (i.e. all
//                      objects using signals and slots ar created and
//                      destroyed from a single thread). Behaviour if objects
//                      are destroyed concurrently is undefined (i.e. you'll
//                      get the occasional segmentation fault/memory
//                      exception).
//
//      multi_threaded_global    - Your program is assumed to be multi
//                      threaded. Objects using signals and slots can be safely
//                      created and destroyed from any thread, even when
//                      connections exist. In multi_threaded_global mode, this
//                      is achieved by a single global mutex (actually a
//                      critical section on Windows because they are faster).
//                      This option uses less OS resources, but results in more
//                      opportunities for contention, possibly resulting in
//                      more context switches than are strictly necessary.
//
//      multi_threaded_local    - Behaviour in this mode is essentially the
//                      same as multi_threaded_global, except that each signal,
//                      and each object that inherits has_slots, all have
//                      their own mutex/critical section. In practice, this
//                      means that mutex collisions (and hence context
//                      switches) only happen if they are absolutely essential.
//                      However, on some platforms, creating a lot of mutexes
//                      can slow down the whole OS, so use this option with
//                      care.
//
//    USING THE LIBRARY
//
...
#if defined(SIGSLOT_PURE_ISO) || (!defined(WEBRTC_WIN) && !defined(__GNUG__)\
...
class _connection_base4 {
 public:
    ...
    virtual _connection_base4<arg1_type, arg2_type, arg3_type, arg4_type,
            mt_policy>* clone() = 0;
    virtual _connection_base4<arg1_type, arg2_type, arg3_type, arg4_type,
            mt_policy>* duplicate(has_slots_interface* pnewdest) = 0;
};
...
class _connection_base6 {
 public:
    ...
    virtual _connection_base6<arg1_type, arg2_type, arg3_type, arg4_type,
        arg5_type, arg6_type, mt_policy>* duplicate(
            has_slots_interface* pnewdest) = 0;
};
...
class _signal_base0 : public _signal_base<mt_policy> {
 public:
    ...
    _signal_base0(const _signal_base0& s)
        ...
        lock_block<mt_policy> lock(this);
        typename connections_list::const_iterator it =
...
class _signal_base3 : public _signal_base<mt_policy>  {
 public:
    typedef std::list<_connection_base3<arg1_type, arg2_type,
                        arg3_type, mt_policy> *>
      connections_list;
    ...
    _signal_base3(const _signal_base3<arg1_type, arg2_type,
        arg3_type, mt_policy>& s)
      : _signal_base<mt_policy>(s) {
      lock_block<mt_policy> lock(this);
      typename connections_list::const_iterator it =
          s.m_connected_slots.begin();
...
class _signal_base4 : public _signal_base<mt_policy> {
 public:
    ...
    _signal_base4(const _signal_base4<arg1_type, arg2_type,
            arg3_type, arg4_type, mt_policy>& s)
      : _signal_base<mt_policy>(s) {
      lock_block<mt_policy> lock(this);
      typename connections_list::const_iterator it =
          s.m_connected_slots.begin();
...
class _connection0 : public _connection_base0<mt_policy> {
 public:
    ...
    virtual _connection_base0<mt_policy>* duplicate(
      ...
      return new _connection0<dest_type, mt_policy>((
...
class _connection2 : public _connection_base2<
    arg1_type, arg2_type, mt_policy> {
 public:
    _connection2() {
      m_pobject = NULL;
      m_pmemfun = NULL;
...
template<class dest_type, class arg1_type, class arg2_type,
    class arg3_type, class mt_policy>
class _connection3 : public _connection_base3<arg1_type,
    arg2_type, arg3_type, mt_policy> {
 public:
    _connection3() {
      m_pobject = NULL;
      m_pmemfun = NULL;
    ...
    virtual _connection_base3<arg1_type, arg2_type, arg3_type,
        mt_policy>* clone() {
      return new _connection3<dest_type, arg1_type, arg2_type,
          arg3_type, mt_policy>(*this);
    }

    virtual _connection_base3<arg1_type, arg2_type, arg3_type,
        mt_policy>* duplicate(has_slots_interface* pnewdest) {
      return new _connection3<dest_type, arg1_type, arg2_type,
          arg3_type, mt_policy>((dest_type *)pnewdest, m_pmemfun);
    }
...
class _connection4 : public _connection_base4<arg1_type, arg2_type,
 ...
 public:
    ...
    virtual _connection_base4<arg1_type, arg2_type, arg3_type,
        arg4_type, mt_policy>* clone() {
      return new _connection4<dest_type, arg1_type, arg2_type,
          arg3_type, arg4_type, mt_policy>(*this);
    }
...
class signal4 : public _signal_base4<arg1_type, arg2_type, arg3_type,
    arg4_type, mt_policy> {
 public:
    typedef _signal_base4<arg1_type, arg2_type, arg3_type, arg4_type,
        mt_policy> base;
    typedef typename base::connections_list connections_list;
    using base::m_connected_slots;
    ...
    signal4(const signal4<arg1_type, arg2_type, arg3_type, arg4_type,
        mt_policy>& s)
      : _signal_base4<arg1_type, arg2_type, arg3_type, arg4_type,
      mt_policy>(s) {
    }
    ...
    template<class desttype>
      ...
      _connection4<desttype, arg1_type, arg2_type, arg3_type, arg4_type,
          mt_policy>* conn = new _connection4<desttype, arg1_type,
          arg2_type, arg3_type, arg4_type, mt_policy>(pclass, pmemfun);
      m_connected_slots.push_back(conn);
      pclass->signal_connect(this);
    }
...
class signal5 : public _signal_base5<arg1_type, arg2_type, arg3_type,
 ...
 public:
    typedef _signal_base5<arg1_type, arg2_type, arg3_type, arg4_type,
        arg5_type, mt_policy> base;
    typedef typename base::connections_list connections_list;
    using base::m_connected_slots;
    ...
    template<class desttype>
      ...
      _connection5<desttype, arg1_type, arg2_type, arg3_type, arg4_type,
        ...
        arg2_type, arg3_type, arg4_type, arg5_type, mt_policy>(
        pclass, pmemfun);
      m_connected_slots.push_back(conn);
      pclass->signal_connect(this);
    }
...
arg4_type, arg5_type, arg6_type, mt_policy> {
 public:
    typedef _signal_base6<arg1_type, arg2_type, arg3_type, arg4_type,
        arg5_type, arg6_type, mt_policy> base;
    typedef typename base::connections_list connections_list;
    using base::m_connected_slots;
