...
if [ "$HOST_OS" == "linux" ] ; then
	...
	echo "android_ndk_path = $Input" > ./projects/android/ninja-mac-arm/Release/conf.ninja
	echo "host_os = $HOST_OS" >> ./projects/android/ninja-mac-arm/Release/conf.ninja
	echo "archtype = $ARCHTYPE" >> ./projects/android/ninja-mac-arm/Release/conf.ninja
	echo "toolchain_version = $TOOLCHAIN_VERSION" >> ./projects/android/ninja-mac-arm/Release/conf.ninja
	
	ninja -C ./projects/android/ninja-mac-arm/Release
else
...
find projects/android/ninja-mac-arm/Release -iname '*.a' -exec cp {} ./../build/android/webrtc/ \;

popd

#clean
ninja -C ./ninja-mac-arm/Release -t clean
